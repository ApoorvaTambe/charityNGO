...
<center>
  <form action="" method="post">
    ...
    <input type="submit" name="Submit" value="Submit"><br />
	  ...
	  <a href="ngoreg.jsp" style="color:#0000CC"> Registration for new NGO</a>
...
rst=stmt.executeQuery("select * from ngo where username='"+s1+"' and password='"+s2+"' and status='Accept'");
if(rst.next()){
session.setAttribute("ngo",rst.getString(1));
session.setAttribute("ngophone",rst.getString(5));
%>
<script>
