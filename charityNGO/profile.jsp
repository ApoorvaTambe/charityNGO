...
<table width="auto" border="0" align="center" style=" border-radius: 14px;">
  <tr style=" border-radius: 14px;" bordercolor="#F0F0F0" bgcolor="#CCCCFF">
    <td align="center" width="auto"><p align="center"><strong>Name </strong>:<%= rst.getString(1) %></p>
      ...
      <p align="center"><strong>NGO Register ID:</strong><%= rst.getString(3) %></p>
      <p align="center"><strong>Phone</strong>:<%= rst.getString(5) %></p>
	   <p align="center"><strong>Contact person</strong>:<%= rst.getString(4) %>	 </p>
     	
	   <p align="center"><strong>ID:</strong>:<%= rst.getString(9) %></p>
	    <p align="center"><strong>Description:</strong>:<%= rst.getString(11) %></p>
