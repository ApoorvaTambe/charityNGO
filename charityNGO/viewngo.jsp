...
<table width="1076" border="0"  align="center">
  <tr bgcolor="#999999">
   <td width="193"><strong>ID</strong></td>
  ...
  <tr bgcolor="#003399">
   <td><span class="style3 style1"><input name="e5" type="text"  value="<%= rst.getString(9) %>"/></span></td>
    ...
    <textarea name="e5" cols="20" rows="4" readonly="true"><%= rst.getString(11) %></textarea>
    </span></td>
